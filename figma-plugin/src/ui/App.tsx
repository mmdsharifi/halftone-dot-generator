...
const App: React.FC = () => {
            ...
            parent.postMessage(
              {
                pluginMessage: {
                  type: "notify",
                  message:
                    "Could not load image. It may be corrupted or in an unsupported format.",
                },
              },
              "*"
            );
  ...
  useEffect(() => {
    ...
    ctx.filter =
      settings.imageBlur > 0 ? `blur(${settings.imageBlur}px)` : "none";
      ...
      parent.postMessage(
        {
          pluginMessage: {
            type: "notify",
            message: "No image selected or SVG not ready.",
          },
        },
        "*"
      );
      ...
      {!imageElement && (
        <div className="app__placeholder">
          ...
          <p className="app__placeholder-text">
            Select a single layer with an image fill in Figma to begin.
          </p>
        </div>
      )}
      <ControlsPanel
